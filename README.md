...
| 구성요소 | 저장 위치 | 실측 |
|---|---|---|
| 노드 | `documents` | 112,255 |
| 엣지 (내부 링크) | `documents.outlinks TEXT[]` | **36,079,456** (문서당 321) |
...
```
✓ 수집                 132062/1117124 문서 수집됨
✓ 파싱                 documents 112255건
✓ 청킹                 chunks 2096966건 (문서당 18.7)
✓ 지식그래프 엣지           36,079,456개 (문서당 321)
✓ 인포박스 관계            302,332건 · 제목 4,429 · 분류 669,562
✓ 관계가 문서로 연결됨        269,000/302,332 (89%)
✓ PageRank 크롬 링크 제외  0건
✓ 엔티티 타입             112,255건 분류됨
✓ 타입 표본 검사           규칙 퇴행 없음
✓ 커뮤니티 탐지            29개 커뮤니티 · 문서 112,251건 배정
✓ 청크 중복 없음           중복 0건
✓ 청크 없는 문서 없음        0건
✓ 카나리아 경보 없음         경보 0건
✓ 임베딩                2096966/2096966 청크
✓ DB↔Qdrant 일치       Qdrant 2097040 vs DB 2096966
