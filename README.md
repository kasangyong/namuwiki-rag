...
프런티어에 37만 건이 발견된 채 대기 중이다. 원하는 만큼 늘릴 수 있다.
...
|---|---|---|
| 노드 | `documents` | 5,069 |
| 엣지 (내부 링크) | `documents.outlinks TEXT[]` | **1,921,207** (문서당 379) |
...
| **KG-2** | 규칙 기반 관계 추출 — 인포박스·분류·제목·리다이렉트 | 예정 |
| **KG-3** | 커뮤니티 요약 (GraphRAG) — 전역 질의 대응 | 예정 |
